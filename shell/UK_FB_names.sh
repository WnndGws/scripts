...
sed -i 's/Midweek XI //g' UK_data.csv
sed -i 's/Division 1 - Sponsored by Learn UK Ltd/Learn UK Div 1/g' UK_data.csv
sed -i 's/ECB Premier Division - Sponsored by Beechwood Mazda/Beechwood Mazda ECB Prem Div/g' UK_data.csv
sed -i 's/Division 3 North - Sponsored by Browns Builders Merchants/Browns Builders Merchants Div 3N/g' UK_data.csv
sed -i 's/Division 5 North - Sponsored by Geoff Cox Cars/Geoff Cox Cars Div 5 N/g' UK_data.csv
