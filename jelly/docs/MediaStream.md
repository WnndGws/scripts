...
**video_range** | [**VideoRange**](VideoRange.md) | Gets the video range. | [optional] [readonly] [default to VideoRange.UNKNOWN]
**video_range_type** | [**VideoRangeType**](VideoRangeType.md) | Gets the video range type. | [optional] [readonly] [default to VideoRangeType.UNKNOWN]
**video_do_vi_title** | **str** | Gets the video dovi title. | [optional] [readonly] 
**audio_spatial_format** | [**AudioSpatialFormat**](AudioSpatialFormat.md) | Gets the audio spatial format. | [optional] [readonly] [default to AudioSpatialFormat.NONE]
