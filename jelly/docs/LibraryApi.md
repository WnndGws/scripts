...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.LibraryApi(api_client)
    library_content_type = openapi_client.CollectionType() # CollectionType | Library content type. (optional)
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.LibraryApi(api_client)
    media_update_info_dto = openapi_client.MediaUpdateInfoDto() # MediaUpdateInfoDto | The update paths.
