...
class UserViewsApi:
    ...
    def get_grouping_options(
        ...
        _param = self._get_grouping_options_serialize(
            user_id=user_id,
    ...
    def get_grouping_options_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[List[SpecialViewOptionDto]]:
        """Get user view grouping options.
    ...
    def _get_grouping_options_serialize(
        self,
        user_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/UserViews/GroupingOptions",
    ...
    def get_user_views(
        self,
        user_id: Annotated[Optional[StrictStr], Field(description="User id.")] = None,
        include_external_content: Annotated[
            Optional[StrictBool],
            Field(
                description="Whether or not to include external views such as channels or live tv."
            ),
        ] = None,
        preset_views: Annotated[
            Optional[List[CollectionType]], Field(description="Preset views.")
        ] = None,
        include_hidden: Annotated[
            Optional[StrictBool],
            Field(description="Whether or not to include hidden content."),
        ] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param user_id: User id.
        :type user_id: str
        :param include_external_content: Whether or not to include
            external views such as channels or live tv.
        :type include_external_content: bool
        :param preset_views: Preset views.
        :type preset_views: List[CollectionType]
        ...
        _param = self._get_user_views_serialize(
            user_id=user_id,
    ...
    def _get_user_views_serialize(
        ...
        if include_external_content is not None:
            _query_params.append(("includeExternalContent", include_external_content))

        if preset_views is not None:
            _query_params.append(("presetViews", preset_views))
