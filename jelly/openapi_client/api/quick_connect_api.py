...
class QuickConnectApi:
    ...
    def authorize_quick_connect(
        ...
        user_id: Annotated[Optional[StrictStr], Field(description="The user the authorize. Access to the requested user is required.")] = None,
        ...
        :type code: str
        :param user_id: The user the authorize. Access to the requested user is required.
        :type user_id: str
        ...
        _param = self._authorize_quick_connect_serialize(
            code=code,
            user_id=user_id,
    ...
    def _authorize_quick_connect_serialize(
        self,
        code,
        user_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/QuickConnect/Authorize',
    ...
    def get_quick_connect_enabled(
        ...
        _param = self._get_quick_connect_enabled_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _get_quick_connect_enabled_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/QuickConnect/Enabled',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_quick_connect_state(
        ...
        _param = self._get_quick_connect_state_serialize(
            secret=secret,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def get_quick_connect_state_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[QuickConnectResult]:
        """Attempts to retrieve authentication information.
    ...
    def _get_quick_connect_state_serialize(
        self,
        secret,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/QuickConnect/Connect',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def initiate_quick_connect(
        ...
        _param = self._initiate_quick_connect_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _initiate_quick_connect_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/QuickConnect/Initiate',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
