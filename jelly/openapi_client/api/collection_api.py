...
class CollectionApi:
    ...
    def add_to_collection(
        ...
        ids: Annotated[List[StrictStr], Field(description="Item ids, comma delimited.")],
    ...
    def _add_to_collection_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/Collections/{collectionId}/Items',
    ...
    def create_collection_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CollectionCreationResult]:
        """Creates a new collection.
