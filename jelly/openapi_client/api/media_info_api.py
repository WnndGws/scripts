...
class MediaInfoApi:
    ...
    def close_live_stream(
        ...
        :param _request_auth: set to override the auth_settings for an a
            single request; this effectively ignores the authentication
            in the spec for a single request.
        :type _request_auth: dict, optional
        :param _content_type: force content-type for the request.
        :type _content_type: str, Optional
        :param _headers: set to override the headers for a single
            request; this effectively ignores the headers in the spec
            for a single request.
        :type _headers: dict, optional
        :param _host_index: set to override the host_index for a single
            request; this effectively ignores the host_index in the spec
            for a single request.
    ...
    def _close_live_stream_serialize(
        ...
        _auth_settings: List[str] = ["CustomAuthentication"]
    ...
    def get_bitrate_test_bytes(
        self,
        size: Annotated[
            Optional[Annotated[int, Field(le=100000000, strict=True, ge=1)]],
            Field(description="The bitrate. Defaults to 102400."),
        ] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def get_playback_info(
        ...
        user_id: Annotated[
            Optional[StrictStr], Field(description="The user id.")
        ] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def get_posted_playback_info(
        ...
        max_streaming_bitrate: Annotated[
            Optional[StrictInt], Field(description="The maximum streaming bitrate.")
        ] = None,
        start_time_ticks: Annotated[
            Optional[StrictInt], Field(description="The start time in ticks.")
        ] = None,
        audio_stream_index: Annotated[
            Optional[StrictInt], Field(description="The audio stream index.")
        ] = None,
        subtitle_stream_index: Annotated[
            Optional[StrictInt], Field(description="The subtitle stream index.")
        ] = None,
        max_audio_channels: Annotated[
            Optional[StrictInt],
            Field(description="The maximum number of audio channels."),
        ] = None,
        media_source_id: Annotated[
            Optional[StrictStr], Field(description="The media source id.")
        ] = None,
        live_stream_id: Annotated[
            Optional[StrictStr], Field(description="The livestream id.")
        ] = None,
        auto_open_live_stream: Annotated[
            Optional[StrictBool],
            Field(description="Whether to auto open the livestream."),
        ] = None,
        enable_direct_play: Annotated[
            Optional[StrictBool],
            Field(description="Whether to enable direct play. Default: true."),
        ] = None,
        enable_direct_stream: Annotated[
            Optional[StrictBool],
            Field(description="Whether to enable direct stream. Default: true."),
        ] = None,
        enable_transcoding: Annotated[
            Optional[StrictBool],
            Field(description="Whether to enable transcoding. Default: true."),
        ] = None,
        allow_video_stream_copy: Annotated[
            Optional[StrictBool],
            Field(
                description="Whether to allow to copy the video stream. Default: true."
            ),
        ] = None,
        allow_audio_stream_copy: Annotated[
            Optional[StrictBool],
            Field(
                description="Whether to allow to copy the audio stream. Default: true."
            ),
        ] = None,
        playback_info_dto: Annotated[
            Optional[PlaybackInfoDto], Field(description="The playback info.")
        ] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        For backwards compatibility parameters can be sent via Query or
        Body, with Query having higher precedence.  Query parameters are
        obsolete.
        ...
        :type live_stream_id: str
        :param auto_open_live_stream: Whether to auto open the
            livestream.
        :type auto_open_live_stream: bool
        :param enable_direct_play: Whether to enable direct play.
            Default: true.
        :type enable_direct_play: bool
        :param enable_direct_stream: Whether to enable direct stream.
            Default: true.
        :type enable_direct_stream: bool
        :param enable_transcoding: Whether to enable transcoding.
            Default: true.
        :type enable_transcoding: bool
        :param allow_video_stream_copy: Whether to allow to copy the
            video stream. Default: true.
        :type allow_video_stream_copy: bool
        :param allow_audio_stream_copy: Whether to allow to copy the
            audio stream. Default: true.
    ...
    def open_live_stream(
        ...
        open_token: Annotated[
            Optional[StrictStr], Field(description="The open token.")
        ] = None,
        user_id: Annotated[
            Optional[StrictStr], Field(description="The user id.")
        ] = None,
        play_session_id: Annotated[
            Optional[StrictStr], Field(description="The play session id.")
        ] = None,
        max_streaming_bitrate: Annotated[
            Optional[StrictInt], Field(description="The maximum streaming bitrate.")
        ] = None,
        ...
        item_id: Annotated[
            Optional[StrictStr], Field(description="The item id.")
        ] = None,
        enable_direct_play: Annotated[
            Optional[StrictBool],
            Field(description="Whether to enable direct play. Default: true."),
        ...
        always_burn_in_subtitle_when_transcoding: Annotated[
            Optional[StrictBool],
            Field(description="Always burn-in subtitle when transcoding."),
        ] = None,
        open_live_stream_dto: Annotated[
            Optional[OpenLiveStreamDto], Field(description="The open live stream dto.")
        ] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
