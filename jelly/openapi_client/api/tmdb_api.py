...
class TmdbApi:
    ...
    def tmdb_client_configuration(
        ...
        _param = self._tmdb_client_configuration_serialize(
    ...
    def _tmdb_client_configuration_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/Tmdb/ClientConfiguration',
