...
class ArtistsApi:
    ...
    def get_album_artists(
        ...
        person_ids: Annotated[Optional[List[StrictStr]], Field(description="Optional. If specified, results will be filtered to include only those containing the specified person ids.")] = None,
