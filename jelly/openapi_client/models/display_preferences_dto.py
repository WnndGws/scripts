...
class DisplayPreferencesDto(BaseModel):
    ...
    scroll_direction: Optional[ScrollDirection] = Field(default=None, description="Gets or sets the scroll direction.", alias="ScrollDirection")
    ...
    sort_order: Optional[SortOrder] = Field(default=None, description="Gets or sets the sort order.", alias="SortOrder")
