...
class TrickplayInfo(BaseModel):
    ...
    bandwidth: Optional[StrictInt] = Field(default=None, description="Gets or sets peak bandwith usage in bits per second.", alias="Bandwidth")
    __properties: ClassVar[List[str]] = ["Width", "Height", "TileWidth", "TileHeight", "ThumbnailCount", "Interval", "Bandwidth"]
