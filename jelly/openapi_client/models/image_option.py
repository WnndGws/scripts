...
class ImageOption(BaseModel):
    ...
    limit: Optional[StrictInt] = Field(default=None, description="Gets or sets the limit.", alias="Limit")
    min_width: Optional[StrictInt] = Field(default=None, description="Gets or sets the minimum width.", alias="MinWidth")
    __properties: ClassVar[List[str]] = ["Type", "Limit", "MinWidth"]
