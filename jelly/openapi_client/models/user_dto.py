...
class UserDto(BaseModel):
    """Class UserDto."""  # noqa: E501

    name: Optional[StrictStr] = Field(
        default=None, description="Gets or sets the name.", alias="Name"
    )
    ...
    server_name: Optional[StrictStr] = Field(
        default=None,
        description="Gets or sets the name of the server.  This is not used by the server and is for client-side usage only.",
        alias="ServerName",
    )
    id: Optional[StrictStr] = Field(
        default=None, description="Gets or sets the id.", alias="Id"
    )
    primary_image_tag: Optional[StrictStr] = Field(
        default=None,
        description="Gets or sets the primary image tag.",
        alias="PrimaryImageTag",
    )
    ...
    configuration: Optional[UserConfiguration] = Field(
        default=None,
        description="Gets or sets the configuration.",
        alias="Configuration",
    )
    policy: Optional[UserPolicy] = Field(
        default=None, description="Gets or sets the policy.", alias="Policy"
    )
    primary_image_aspect_ratio: Optional[Union[StrictFloat, StrictInt]] = Field(
        default=None,
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # and model_fields_set contains the field
        if (
            self.primary_image_tag is None
            and "primary_image_tag" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.enable_auto_login is None
            and "enable_auto_login" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.last_activity_date is None
            and "last_activity_date" in self.model_fields_set
        ):
        ...
        # and model_fields_set contains the field
        if (
            self.primary_image_aspect_ratio is None
            and "primary_image_aspect_ratio" in self.model_fields_set
        ):
        ...
        _obj = cls.model_validate(
            {
                ...
                "Configuration": UserConfiguration.from_dict(obj["Configuration"])
                if obj.get("Configuration") is not None
                else None,
                "Policy": UserPolicy.from_dict(obj["Policy"])
