...
class LibraryOptions(BaseModel):
    ...
    allow_embedded_subtitles: Optional[EmbeddedSubtitleOptions] = Field(default=None, description="An enum representing the options to disable embedded subs.", alias="AllowEmbeddedSubtitles")
