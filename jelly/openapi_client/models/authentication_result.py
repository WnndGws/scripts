...
class AuthenticationResult(BaseModel):
    ...
    """ # noqa: E501
    user: Optional[UserDto] = Field(default=None, description="Gets or sets the user.", alias="User")
    session_info: Optional[SessionInfoDto] = Field(default=None, description="Gets or sets the session info.", alias="SessionInfo")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if session_info (nullable) is None
        # and model_fields_set contains the field
        if self.session_info is None and "session_info" in self.model_fields_set:
            _dict['SessionInfo'] = None
