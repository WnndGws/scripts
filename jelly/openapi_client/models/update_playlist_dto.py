...
class UpdatePlaylistDto(BaseModel):
    ...
    ids: Optional[List[StrictStr]] = Field(default=None, description="Gets or sets item ids of the playlist.", alias="Ids")
    ...
    __properties: ClassVar[List[str]] = ["Name", "Ids", "Users", "IsPublic"]
