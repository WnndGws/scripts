...
class MediaStream(BaseModel):
    ...
    video_range: Optional[VideoRange] = Field(default=VideoRange.UNKNOWN, description="Gets the video range.", alias="VideoRange")
    video_range_type: Optional[VideoRangeType] = Field(default=VideoRangeType.UNKNOWN, description="Gets the video range type.", alias="VideoRangeType")
    video_do_vi_title: Optional[StrictStr] = Field(default=None, description="Gets the video dovi title.", alias="VideoDoViTitle")
    audio_spatial_format: Optional[AudioSpatialFormat] = Field(default=AudioSpatialFormat.NONE, description="Gets the audio spatial format.", alias="AudioSpatialFormat")
