...
class PlaybackInfoDto(BaseModel):
    ...
    Plabyback info dto.
    """ # noqa: E501
    user_id: Optional[StrictStr] = Field(default=None, description="Gets or sets the playback userId.", alias="UserId")
    ...
    device_profile: Optional[DeviceProfile] = Field(default=None, description="A MediaBrowser.Model.Dlna.DeviceProfile represents a set of metadata which determines which content a certain device is able to play.  <br />  Specifically, it defines the supported <see cref=\"P:MediaBrowser.Model.Dlna.DeviceProfile.ContainerProfiles\">containers</see> and  <see cref=\"P:MediaBrowser.Model.Dlna.DeviceProfile.CodecProfiles\">codecs</see> (video and/or audio, including codec profiles and levels)  the device is able to direct play (without transcoding or remuxing),  as well as which <see cref=\"P:MediaBrowser.Model.Dlna.DeviceProfile.TranscodingProfiles\">containers/codecs to transcode to</see> in case it isn't.", alias="DeviceProfile")
