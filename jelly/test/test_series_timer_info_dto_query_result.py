...
class TestSeriesTimerInfoDtoQueryResult(unittest.TestCase):
    """SeriesTimerInfoDtoQueryResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SeriesTimerInfoDtoQueryResult:
        """Test SeriesTimerInfoDtoQueryResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SeriesTimerInfoDtoQueryResult`
        """
        model = SeriesTimerInfoDtoQueryResult()
        if include_optional:
            return SeriesTimerInfoDtoQueryResult(
                items = [
                    openapi_client.models.series_timer_info_dto.SeriesTimerInfoDto(
                        id = '', 
                        type = '', 
                        server_id = '', 
                        external_id = '', 
    ...
    def testSeriesTimerInfoDtoQueryResult(self):
        """Test SeriesTimerInfoDtoQueryResult"""
