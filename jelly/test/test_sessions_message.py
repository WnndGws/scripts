...
class TestSessionsMessage(unittest.TestCase):
    """SessionsMessage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SessionsMessage:
        """Test SessionsMessage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SessionsMessage`
        """
        model = SessionsMessage()
        if include_optional:
            return SessionsMessage(
                data = [
                    openapi_client.models.session_info_dto.SessionInfoDto(
                        play_state = null, 
                        additional_users = [
