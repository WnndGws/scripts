...
class TestPlaybackStartInfo(unittest.TestCase):
    """PlaybackStartInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PlaybackStartInfo:
        """Test PlaybackStartInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PlaybackStartInfo`
        """
        model = PlaybackStartInfo()
        if include_optional:
    ...
    def testPlaybackStartInfo(self):
        """Test PlaybackStartInfo"""
