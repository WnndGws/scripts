...
class TestOpenLiveStreamDto(unittest.TestCase):
    """OpenLiveStreamDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OpenLiveStreamDto:
        """Test OpenLiveStreamDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OpenLiveStreamDto`
        """
        model = OpenLiveStreamDto()
        if include_optional:
    ...
    def testOpenLiveStreamDto(self):
        """Test OpenLiveStreamDto"""
