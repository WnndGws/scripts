...
class TestAddVirtualFolderDto(unittest.TestCase):
    """AddVirtualFolderDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AddVirtualFolderDto:
        """Test AddVirtualFolderDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AddVirtualFolderDto`
        """
        model = AddVirtualFolderDto()
        if include_optional:
            return AddVirtualFolderDto(
                library_options = openapi_client.models.library_options.LibraryOptions(
                    enabled = True, 
                    enable_photos = True, 
    ...
    def testAddVirtualFolderDto(self):
        """Test AddVirtualFolderDto"""
