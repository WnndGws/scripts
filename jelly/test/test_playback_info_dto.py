...
class TestPlaybackInfoDto(unittest.TestCase):
    """PlaybackInfoDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PlaybackInfoDto:
        """Test PlaybackInfoDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PlaybackInfoDto`
        """
        model = PlaybackInfoDto()
        if include_optional:
