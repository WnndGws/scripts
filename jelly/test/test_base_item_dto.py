...
class TestBaseItemDto(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> BaseItemDto:
        """Test BaseItemDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BaseItemDto`
        """
        model = BaseItemDto()
        if include_optional:
            return BaseItemDto(
                ...
                user_data = openapi_client.models.user_item_data_dto.UserItemDataDto(
                    rating = 1.337, 
                ...
                current_program = openapi_client.models.base_item_dto.BaseItemDto(
                    name = '', 
                    original_title = '', 
                    server_id = '', 
                    id = '', 
