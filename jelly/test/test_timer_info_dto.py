...
class TestTimerInfoDto(unittest.TestCase):
    """TimerInfoDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TimerInfoDto:
        """Test TimerInfoDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TimerInfoDto`
        """
        model = TimerInfoDto()
        if include_optional:
            return TimerInfoDto(
                ...
                run_time_ticks = 56,
                program_info = openapi_client.models.base_item_dto.BaseItemDto(
                    name = '', 
                    original_title = '', 
                    server_id = '', 
                    id = '', 
