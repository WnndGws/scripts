...
class TestSessionInfoDto(unittest.TestCase):
    """SessionInfoDto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SessionInfoDto:
        """Test SessionInfoDto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SessionInfoDto`
        """
        model = SessionInfoDto()
        if include_optional:
            return SessionInfoDto(
                play_state = openapi_client.models.player_state_info.PlayerStateInfo(
                    position_ticks = 56, 
                    can_seek = True, 
                    is_paused = True, 
                    is_muted = True, 
                    ...
                    live_stream_id = '', ),
                additional_users = [
                    openapi_client.models.session_user_info.SessionUserInfo(
                        user_id = '', 
                        user_name = '', )
                    ],
                ...
                last_playback_check_in = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                last_paused_date = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                device_name = '',
                device_type = '',
                now_playing_item = openapi_client.models.base_item_dto.BaseItemDto(
                    name = '', 
                    original_title = '', 
                    server_id = '', 
                    id = '', 
                ...
                now_viewing_item = openapi_client.models.base_item_dto.BaseItemDto(
                    name = '', 
                    original_title = '', 
                    server_id = '', 
                    id = '', 
                ...
                device_id = '',
                application_version = '',
                transcoding_info = openapi_client.models.transcoding_info.TranscodingInfo(
                    audio_codec = '', 
                    video_codec = '', 
                    container = '', 
                ...
                now_playing_queue_full_items = [
                    openapi_client.models.base_item_dto.BaseItemDto(
                        name = '', 
                        original_title = '', 
                        server_id = '', 
                        id = '', 
