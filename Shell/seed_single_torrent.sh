...
# 25megs is more than enough for the average household.
aria2c --max-overall-download-limit=25M --bt-force-encryption=true --bt-require-crypto=true --bt-max-peers=0 --bt-detach-seed-only=true --bt-seed-unverified=true $file --dir $directory --select-file="$file_number" --index-out="$file_number"=$file_name.mkv
